    ...
    <>
      ...
      <main class="relative min-h-screen flex items-center justify-center bg-black">
        ...
        <div class="relative z-20 min-w-[800px] max-w-3xl w-full mx-auto bg-black/70 rounded-xl p-8 text-white flex flex-col items-center sm:min-w-0">
          ...
          <div class="tour-date upcoming w-full border-green-500 bg-green-500/10 border mb-6 p-6 rounded-xl flex flex-col md:flex-row justify-between items-center gap-4">
            <div class="date-info font-bold text-lg min-w-[120px]">2025</div>
            <div class="venue-info text-base">
              <p>2025 Tour Dates Coming Soon<br />Check back for updates</p>
            </div>
          </div>

          <div class="tour-date w-full border border-white/30 mb-6 p-6 rounded-xl flex flex-col md:flex-row justify-between items-center gap-4">
            <div class="date-info font-bold text-lg min-w-[120px]">May 16, 2025</div>
            <div class="venue-info text-base">
          ...
          <div class="tour-date past w-full border border-white/30 opacity-70 mb-6 p-6 rounded-xl flex flex-col md:flex-row justify-between items-center gap-4">
            <div class="date-info font-bold text-lg min-w-[120px]">March 9, 2025</div>
            <div class="venue-info text-base">
          ...
          <div class="tour-date past w-full border border-white/30 opacity-70 mb-6 p-6 rounded-xl flex flex-col md:flex-row justify-between items-center gap-4">
            <div class="date-info font-bold text-lg min-w-[120px]">December 20, 2024</div>
            <div class="venue-info text-base">
          ...
          <div class="tour-date past w-full border border-white/30 opacity-70 mb-6 p-6 rounded-xl flex flex-col md:flex-row justify-between items-center gap-4">
            <div class="date-info font-bold text-lg min-w-[120px]">November 17, 2024</div>
            <div class="venue-info text-base">
          ...
          <div class="tour-date past w-full border border-white/30 opacity-70 mb-6 p-6 rounded-xl flex flex-col md:flex-row justify-between items-center gap-4">
            <div class="date-info font-bold text-lg min-w-[120px]">October 25, 2024</div>
            <div class="venue-info text-base">
