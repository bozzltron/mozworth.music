        ...
        <main id="main-content" class="flex-1 flex items-center justify-center relative bg-black light:bg-stone-100">
          ...
          <div class="relative container mx-0 md:mx-auto md:mt-10 md:mb-10 text-center flex flex-col items-center max-w-[800px] p-4 md:p-4 md:rounded-[10px] bg-black/70 light:bg-white/90 text-white light:text-gray-900">
            <h1 class="text-3xl font-bold mb-8 text-center">Support mozworth</h1>
                        ...
                        <p class="text-white/90 light:text-gray-700 leading-relaxed text-center mb-8">
            ...
            <div class="space-y-6 w-full mt-6">
               ...
               <div class="space-y-4 mb-8">
                   ...
                   <div id="donate-section" style={{"display":"none"}} class="px-6 pb-6">
                     <div class="grid grid-cols-4 gap-4 mt-4">
                       <a href="https://cash.app/$mozworth" target="_blank" rel="noopener noreferrer" class="flex flex-col items-center p-4 rounded-xl hover:bg-white/5 light:hover:bg-gray-200/50 transition-colors group focus:outline-none focus:ring-2 focus:ring-teal-400 focus:ring-offset-2 focus:ring-offset-black" onClick={() => { if (window.gtag) window.gtag('event', 'support_click', { event_category: 'support', event_label: 'Cash App', destination: 'cashapp' }); }} aria-label="Send money via Cash App (opens in new tab)">
                         ...
                         <span class="text-sm text-center text-white light:text-gray-900 font-semibold">Cash App</span>
                       </a>
                       
                       <a href="https://mozworth.bandcamp.com/" target="_blank" rel="noopener noreferrer" class="flex flex-col items-center p-4 rounded-xl hover:bg-white/5 light:hover:bg-gray-200/50 transition-colors group" onClick={() => { if (window.gtag) window.gtag('event', 'support_click', { event_category: 'support', event_label: 'Bandcamp', destination: 'bandcamp' }); }}>
                         ...
                         <span class="text-sm text-center text-white light:text-gray-900 font-semibold">Bandcamp</span>
                       </a>
                       
                       <a href="https://mozworth.printful.me/" target="_blank" rel="noopener noreferrer" class="flex flex-col items-center p-4 rounded-xl hover:bg-white/5 light:hover:bg-gray-200/50 transition-colors group" onClick={() => { if (window.gtag) window.gtag('event', 'support_click', { event_category: 'support', event_label: 'Merch', destination: 'printful' }); }}>
                 ...
                 <div class="bg-black/40 light:bg-white/60 border border-white/20 light:border-gray-200 rounded-lg">
                   <button class="w-full px-6 py-4 text-left rounded-lg hover:bg-black/60 light:hover:bg-gray-100 transition-colors" onClick={() => {
                     const el = document.getElementById('stream-section');
                     if (el) el.style.display = el.style.display === 'none' ? 'block' : 'none';
                   }}>
                     <h2 class="text-xl font-bold text-teal-300">Follow & Stream</h2>
                     <p class="text-white/70 light:text-gray-600 text-sm mt-1">Choose high-paying platforms and follow for discovery</p>
                   </button>
                   ...
                   <div id="stream-section" style={{"display":"none"}} class="px-6 pb-6">
                     ...
                     <div class="grid grid-cols-4 gap-3">
                       <a href="https://tidal.com/browse/artist/49656537" target="_blank" rel="noopener noreferrer" class="flex flex-col items-center p-3 rounded-xl hover:bg-white/5 light:hover:bg-gray-200/50 transition-colors group" onClick={() => { if (window.gtag) window.gtag('event', 'support_click', { event_category: 'streaming', event_label: 'Tidal', destination: 'tidal' }); }}>
                         ...
                         <span class="text-xs text-center text-white light:text-gray-900 font-semibold">Tidal</span>
                       </a>
                       <a href="https://music.apple.com/us/artist/mozworth/1761894108" target="_blank" rel="noopener noreferrer" class="flex flex-col items-center p-3 rounded-xl hover:bg-white/5 light:hover:bg-gray-200/50 transition-colors group" onClick={() => { if (window.gtag) window.gtag('event', 'support_click', { event_category: 'streaming', event_label: 'Apple Music', destination: 'apple_music' }); }}>
                         ...
                         <span class="text-xs text-center text-white light:text-gray-900 font-semibold">Apple Music</span>
                       </a>
                       <a href="https://open.spotify.com/artist/19yvsMNCISApooxkEt0aMO" target="_blank" rel="noopener noreferrer" class="flex flex-col items-center p-3 rounded-xl hover:bg-white/5 light:hover:bg-gray-200/50 transition-colors group" onClick={() => { if (window.gtag) window.gtag('event', 'support_click', { event_category: 'streaming', event_label: 'Spotify', destination: 'spotify' }); }}>
                         ...
                         <span class="text-xs text-center text-white light:text-gray-900 font-semibold">Spotify</span>
                       </a>
                       <a href="https://soundcloud.com/mozworth" target="_blank" rel="noopener noreferrer" class="flex flex-col items-center p-3 rounded-xl hover:bg-white/5 light:hover:bg-gray-200/50 transition-colors group" onClick={() => { if (window.gtag) window.gtag('event', 'support_click', { event_category: 'streaming', event_label: 'SoundCloud', destination: 'soundcloud' }); }}>
                         ...
                         <span class="text-xs text-center text-white light:text-gray-900 font-semibold">SoundCloud</span>
                       </a>
                       <a href="https://music.amazon.com/artists/B0DCMD1NQ7/mozworth" target="_blank" rel="noopener noreferrer" class="flex flex-col items-center p-3 rounded-xl hover:bg-white/5 light:hover:bg-gray-200/50 transition-colors group" onClick={() => { if (window.gtag) window.gtag('event', 'support_click', { event_category: 'streaming', event_label: 'Amazon Music', destination: 'amazon_music' }); }}>
                         ...
                         <span class="text-xs text-center text-white light:text-gray-900 font-semibold">Amazon Music</span>
                       </a>
                       <a href="https://www.youtube.com/@mozworthmusic" target="_blank" rel="noopener noreferrer" class="flex flex-col items-center p-3 rounded-xl hover:bg-white/5 light:hover:bg-gray-200/50 transition-colors group">
                         ...
                         <span class="text-xs text-center text-white light:text-gray-900 font-semibold">YouTube</span>
                       </a>
                       <a href="https://www.deezer.com/us/artist/277222071" target="_blank" rel="noopener noreferrer" class="flex flex-col items-center p-3 rounded-xl hover:bg-white/5 light:hover:bg-gray-200/50 transition-colors group" onClick={() => { if (window.gtag) window.gtag('event', 'support_click', { event_category: 'streaming', event_label: 'Deezer', destination: 'deezer' }); }}>
                         ...
                         <span class="text-xs text-center text-white light:text-gray-900 font-semibold">Deezer</span>
                       </a>
                     </div>
                     <p class="text-white/50 light:text-gray-500 text-xs mt-4">
                 ...
                 <div class="bg-black/40 light:bg-white/60 border border-white/20 light:border-gray-200 rounded-lg">
                   <button class="w-full px-6 py-4 text-left rounded-lg hover:bg-black/60 light:hover:bg-gray-100 transition-colors" onClick={() => {
                     ...
                     <p class="text-white/70 light:text-gray-600 text-sm mt-1">Spread the word and build community using #mozworth</p>
                   </button>
                   
                   <div id="social-section" style={{"display":"none"}} class="px-6 pb-6">
                     <div class="grid grid-cols-4 gap-3 mt-4">
                       <a href="https://bsky.app/profile/mozworth.music" target="_blank" rel="noopener noreferrer" class="flex flex-col items-center p-3 rounded-xl hover:bg-white/5 light:hover:bg-gray-200/50 transition-colors group" onClick={() => { if (window.gtag) window.gtag('event', 'support_click', { event_category: 'social', event_label: 'Bluesky', destination: 'bluesky' }); }}>
                         ...
                         <span class="text-xs text-center text-white light:text-gray-900 font-semibold">Bluesky</span>
                       </a>
                       <a href="https://www.reddit.com/user/mozworth" target="_blank" rel="noopener noreferrer" class="flex flex-col items-center p-3 rounded-xl hover:bg-white/5 light:hover:bg-gray-200/50 transition-colors group">
                         ...
                         <span class="text-xs text-center text-white light:text-gray-900 font-semibold">Reddit</span>
                       </a>
                       <a href="https://www.tiktok.com/@mozworthmusic" target="_blank" rel="noopener noreferrer" class="flex flex-col items-center p-3 rounded-xl hover:bg-white/5 light:hover:bg-gray-200/50 transition-colors group">
                         ...
                         <span class="text-xs text-center text-white light:text-gray-900 font-semibold">TikTok</span>
                       </a>
                       <a href="https://www.youtube.com/@mozworthmusic" target="_blank" rel="noopener noreferrer" class="flex flex-col items-center p-3 rounded-xl hover:bg-white/5 light:hover:bg-gray-200/50 transition-colors group">
                         <div class="w-10 h-10 bg-red-600 rounded-lg flex items-center justify-center mb-2 group-hover:bg-red-500 transition-colors">
                           <img src="/youtube.svg" alt="YouTube" class="w-5 h-5 filter brightness-0 invert" />
                       ...
                       <a href="https://www.instagram.com/mozworthmusic/" target="_blank" rel="noopener noreferrer" class="flex flex-col items-center p-3 rounded-xl hover:bg-white/5 light:hover:bg-gray-200/50 transition-colors group">
                         ...
                         <span class="text-xs text-center text-white light:text-gray-900 font-semibold">Instagram</span>
                       </a>
                       <a href="https://www.threads.net/@mozworthmusic" target="_blank" rel="noopener noreferrer" class="flex flex-col items-center p-3 rounded-xl hover:bg-white/5 light:hover:bg-gray-200/50 transition-colors group">
                         <div class="w-10 h-10 bg-black rounded-lg flex items-center justify-center mb-2 group-hover:bg-gray-800 transition-colors border border-white/20 light:border-gray-300">
                           <img src="/threads.svg" alt="Threads" class="w-5 h-5 filter brightness-0 invert" />
                   </div>
                         <span class="text-xs text-center text-white light:text-gray-900 font-semibold">Threads</span>
                       </a>
                       <a href="https://www.bandsintown.com/a/15561057-mozworth" target="_blank" rel="noopener noreferrer" class="flex flex-col items-center p-3 rounded-xl hover:bg-white/5 light:hover:bg-gray-200/50 transition-colors group">
                         <div class="w-10 h-10 bg-blue-600 rounded-lg flex items-center justify-center mb-2 group-hover:bg-blue-500 transition-colors">
                           <img src="/bandsintown.svg" alt="Bandsintown" class="w-5 h-5 filter brightness-0 invert" />
                   </div>
                         <span class="text-xs text-center text-white light:text-gray-900 font-semibold">Bandsintown</span>
                       </a>
                       <a href="https://www.facebook.com/mozworth" target="_blank" rel="noopener noreferrer" class="flex flex-col items-center p-3 rounded-xl hover:bg-white/5 light:hover:bg-gray-200/50 transition-colors group">
                         ...
                         <span class="text-xs text-center text-white light:text-gray-900 font-semibold">Facebook</span>
                     </a>
                   </div>
                   </div>
                 </div>
