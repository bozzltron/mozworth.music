        ...
        <main id="main-content" class="flex-1 flex items-center justify-center relative bg-black light:bg-stone-100">
          ...
          <div class="relative container mx-0 md:mx-auto md:mt-10 md:mb-10 text-center flex flex-col items-center max-w-[800px] p-4 md:p-4 md:rounded-[10px] bg-black/70 light:bg-white/90 text-white light:text-gray-900">
            ...
            <section aria-label="Music releases" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 w-full mt-6">
              {/* Story of an Artist */}
              <a href="/songs/story-of-an-artist" class="release group bg-gradient-to-br from-teal-900/30 to-purple-900/30 light:from-teal-100 light:to-purple-100 border-2 border-teal-400/50 light:border-teal-300 rounded-lg md:rounded-xl p-4 flex flex-col items-center text-center transition-transform duration-200 hover:scale-105 hover:shadow-teal-400/50 light:hover:shadow-teal-500/30 w-full mx-auto relative overflow-hidden focus:outline-none focus:ring-2 focus:ring-teal-400 focus:ring-offset-2 focus:ring-offset-black light:focus:ring-offset-stone-100" onClick={() => { if (window.gtag) window.gtag('event', 'release_click', { event_category: 'music', event_label: 'Story of an Artist', destination: '/songs/story-of-an-artist' }); }} aria-label="Story of an Artist - Single released January 22, 2026">
                ...
                <h2 class="text-xl font-bold mb-2 text-teal-300 light:text-teal-600 group-hover:text-teal-200 light:group-hover:text-teal-700 transition-colors">Story of an Artist</h2>
                <p class="text-white/90 light:text-gray-800 mb-1 font-semibold">January 22, 2026</p>
                <p class="text-white/70 light:text-gray-600 text-sm mb-4 italic">"A heartfelt tribute that feels both tender and alive—Daniel Johnston's spirit resonates through every note." – musikepool</p>
              </a>
              {/* Sandpiper (Upcoming) */}
              <a href="/songs/sandpiper" class="release group bg-black/50 light:bg-white/80 border border-white/10 light:border-gray-200 rounded-lg md:rounded-xl p-4 flex flex-col items-center text-center transition-transform duration-200 hover:scale-105 hover:shadow-teal-400/30 light:hover:shadow-teal-500/20 w-full mx-auto focus:outline-none focus:ring-2 focus:ring-teal-400 focus:ring-offset-2 focus:ring-offset-black light:focus:ring-offset-stone-100" onClick={() => { if (window.gtag) window.gtag('event', 'release_click', { event_category: 'music', event_label: 'Sandpiper', destination: '/songs/sandpiper' }); }} aria-label="Sandpiper - Single releasing September 15, 2025">
                <img src="/sandpiper.webp" alt="Sandpiper single cover featuring watercolor artwork and coastal hues" class="w-full aspect-square object-cover mb-4 rounded shadow-lg group-hover:shadow-teal-400/40 transition-shadow duration-200" loading="lazy" decoding="async" />
                <h2 class="text-xl font-bold mb-2 group-hover:text-teal-300 light:group-hover:text-teal-600 transition-colors">Sandpiper</h2>
                <p class="text-white/70 light:text-gray-600 mb-1">September 15, 2025</p>
                <p class="text-white/60 light:text-gray-500 text-sm mb-4">"A spectacular alternative jam that's timeless and truly absorbing throughout." – Plastic Magazine</p>
              </a>
              {/* The Sky Is Falling */}
              <a href="/songs/the-sky-is-falling" class="release group bg-black/50 light:bg-white/80 border border-white/10 light:border-gray-200 rounded-lg md:rounded-xl p-4 flex flex-col items-center text-center transition-transform duration-200 hover:scale-105 hover:shadow-teal-400/30 light:hover:shadow-teal-500/20 w-full mx-auto focus:outline-none focus:ring-2 focus:ring-teal-400 focus:ring-offset-2 focus:ring-offset-black light:focus:ring-offset-stone-100" onClick={() => { if (window.gtag) window.gtag('event', 'release_click', { event_category: 'music', event_label: 'The Sky Is Falling', destination: '/songs/the-sky-is-falling' }); }} aria-label="The Sky Is Falling - Single released July 15, 2025">
                <img src="/the_sky_is_falling.webp" alt="The Sky Is Falling single cover showing a dramatic stormy sky" class="w-full aspect-square object-cover mb-4 rounded shadow-lg group-hover:shadow-teal-400/40 transition-shadow duration-200" loading="lazy" decoding="async" />
                ...
                <p class="text-white/60 light:text-gray-500 text-sm mb-4">“An absolutely essential document of our times.” – The Big Takeover</p>
              </a>
              {/* Walking The Cow */}
              <a href="/songs/walking-the-cow" class="release group bg-black/50 light:bg-white/80 border border-white/10 light:border-gray-200 rounded-lg md:rounded-xl p-4 flex flex-col items-center text-center transition-transform duration-200 hover:scale-105 hover:shadow-teal-400/30 light:hover:shadow-teal-500/20 w-full  mx-auto focus:outline-none focus:ring-2 focus:ring-teal-400 focus:ring-offset-2 focus:ring-offset-black light:focus:ring-offset-stone-100" onClick={() => { if (window.gtag) window.gtag('event', 'release_click', { event_category: 'music', event_label: 'Walking The Cow', destination: '/songs/walking-the-cow' }); }} aria-label="Walking The Cow - Cover song released January 22, 2025">
                <img src="/mozworth-walking-the-cow-cover.webp" alt="Walking The Cow cover featuring artistic cow imagery in honor of Daniel Johnston" class="w-full aspect-square object-cover mb-4 rounded shadow-lg group-hover:shadow-teal-400/40 transition-shadow duration-200" loading="lazy" decoding="async" />
              ...
              <div class="release group bg-black/50 light:bg-white/80 border border-white/10 light:border-gray-200 rounded-lg md:rounded-xl p-4 flex flex-col items-center text-center transition-transform duration-200 hover:scale-105 hover:shadow-teal-400/30 light:hover:shadow-teal-500/20 w-full mx-auto">
                <a href="/albums/mozworth" class="flex flex-col items-center text-center w-full rounded-lg focus:outline-none focus:ring-2 focus:ring-teal-400 focus:ring-offset-2 focus:ring-offset-black light:focus:ring-offset-stone-100" onClick={() => { if (window.gtag) window.gtag('event', 'release_click', { event_category: 'music', event_label: 'mozworth', destination: '/albums/mozworth' }); }} aria-label="mozworth - Debut album released November 15, 2024">
                  <img src="/mozworth-debut.webp" alt="mozworth debut album cover featuring artist's portrait in moody lighting" class="w-full aspect-square object-cover mb-4 rounded shadow-lg group-hover:shadow-teal-400/40 transition-shadow duration-200" loading="lazy" decoding="async" />
                ...
                <a href={MOZWORTH_DEBUT_VINYL_URL} target="_blank" rel="noopener noreferrer" class="text-sm font-semibold text-teal-300 light:text-teal-600 hover:underline mb-1 focus:outline-none focus:ring-2 focus:ring-teal-400 rounded" onClick={() => { if (window.gtag) window.gtag('event', 'commerce_click', { event_category: 'vinyl', event_label: 'music_page_debut_card', destination: 'elasticstage' }); }} aria-label="Buy debut album on vinyl at elasticStage (opens in new tab)">Buy on Vinyl</a>
              </div>
              {/* Goodbye Colorado */}
              <a href="/songs/goodbye-colorado" class="release group bg-black/50 light:bg-white/80 border border-white/10 light:border-gray-200 rounded-lg md:rounded-xl p-4 flex flex-col items-center text-center transition-transform duration-200 hover:scale-105 hover:shadow-teal-400/30 light:hover:shadow-teal-500/20 w-full  mx-auto focus:outline-none focus:ring-2 focus:ring-teal-400 focus:ring-offset-2 focus:ring-offset-black light:focus:ring-offset-stone-100" onClick={() => { if (window.gtag) window.gtag('event', 'release_click', { event_category: 'music', event_label: 'Goodbye Colorado', destination: '/songs/goodbye-colorado' }); }} aria-label="Goodbye Colorado - Single released October 9, 2024">
                <img src="/goodbye_colorado_cover.webp" alt="Goodbye Colorado single cover showing Colorado mountain landscape at sunset" class="w-full aspect-square object-cover mb-4 rounded shadow-lg group-hover:shadow-teal-400/40 transition-shadow duration-200" loading="lazy" decoding="async" />
              ...
              <a href="/songs/postcard" class="release group bg-black/50 light:bg-white/80 border border-white/10 light:border-gray-200 rounded-lg md:rounded-xl p-4 flex flex-col items-center text-center transition-transform duration-200 hover:scale-105 hover:shadow-teal-400/30 light:hover:shadow-teal-500/20 w-full mx-auto focus:outline-none focus:ring-2 focus:ring-teal-400 focus:ring-offset-2 focus:ring-offset-black light:focus:ring-offset-stone-100" onClick={() => { if (window.gtag) window.gtag('event', 'release_click', { event_category: 'music', event_label: 'Postcard', destination: '/songs/postcard' }); }} aria-label="Postcard - Single released September 12, 2024">
                <img src="/postcard_cover.webp" alt="Postcard single cover featuring vintage postcard design with nostalgic imagery" class="w-full aspect-square object-cover mb-4 rounded shadow-lg group-hover:shadow-teal-400/40 transition-shadow duration-200" loading="lazy" decoding="async" />
